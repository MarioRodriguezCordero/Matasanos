...
class VisitaMedica {
  ...
  VisitaMedica() {
    ...
    this._dia = this._fecha.day.toString() +
        '/' +
        this._fecha.month.toString() +
        '/' +
        this._fecha.year.toString();
    this._hora =
        this._fecha.hour.toString() + ':' + this._fecha.minute.toString();
  }

  //Constructores con parametros
  VisitaMedica.withOutId(
      String especialidad, String doctor, String lugar, DateTime fecha) {
  ...
  VisitaMedica.withId(int id, String especialidad, String doctor, String lugar,
      DateTime fecha) {
    this._id = id;
    this._especialidad = especialidad;
    this._doctor = doctor;
  ...
  set dia(String dia) {
    ...
    this._fecha =
        new DateTime(yyyy, mm, dd, this._fecha.hour, this._fecha.minute);
  }
  ...
  set hora(String hora) {
    ...
    this.fecha = new DateTime(
        this._fecha.year, this._fecha.month, this._fecha.day, horas, minutos);
  }
